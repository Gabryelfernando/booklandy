	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="cadastrar_log.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Nome é requirido">
						<input class="input100" type="nome" name="nome" placeholder="Nome">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
